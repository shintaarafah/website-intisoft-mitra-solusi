...
<section class="banner-home" id="banner-home">
    <div class="banner-content">
        ...
        <div class="banner-text">
            <h1 style="color: #0231D0; font-weight: 650;">Solusi Terdepan untuk</h1>
            <h1 style="font-weight: 600;"> Dunia Digital </h1>
...
<section class="customer">
    <h3 class="text-center fw-bold" style="margin-top: 60px; margin-bottom: 30px;"> Pelanggan </h3>
    <div class="customer-card">
        ...
        <div class="card"><img src="/img/pt-dharmatama.svg" alt="Bank Bumiputera"></div>
        <div class="card"><img src="/img/askrindo.svg" alt="Bank Riau Kepri"></div>
